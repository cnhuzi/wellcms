...
function admin_token_check()
{
    ...
    if (empty($admin_token)) {
        ...
        if (empty($s)) {
            setcookie($conf['cookie_pre'] . 'admin_token', '', 0, '', '', '', TRUE);
...
function admin_token_set()
{
    ...
    setcookie($conf['cookie_pre'] . 'admin_token', $admin_token, $time + 3600, '', '', 0, TRUE);
...
function admin_token_clean()
{
    ...
    setcookie($conf['cookie_pre'] . 'admin_token', '', $time - 86400, '', '', 0, TRUE);
