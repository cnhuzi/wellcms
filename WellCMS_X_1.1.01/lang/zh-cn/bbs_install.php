...
return array(
	...
	'license_title' => 'WellCMS 1.0 中文版授权协议',
	'license_content' => '感谢您选择 WellCMS X 1.0.0，它是一款倾向移动端的内容管理产品，具有安全、高效、稳定、速度快、负载超强的特点，尤其在大数据量下它的优秀才更显卓越，同时在SEO方面做了大量优化。基于优秀的XiunoPHP开发，同时沿用了Xiuno bbs的精华之处，作者再次对核心进行了增强，其目的是榨干硬件的全部运算性能。

WellCMS X 版本中的 X 取自“Extreme”，意为轻便到了极点；意为追求极致；意为自由飞翔，需要轻盈的体态；意为将程序的性能发挥到极限。

WellCMS X 1.0.0 只有 18 个表，源代码压缩后 1M 左右，运行速度非常快，处理单次请求在 0.01 秒级别。分布式服务器设计，每张表都可创建单独的DB服务器群和CACHE服务器(群)，单表可承受高达亿级数据，方便部署和维护，是一个二次开发非常好的基石。

采用 Bootstrap 4 + JQuery 3 作为前端类库，全面支持移动端浏览器；后端基于 PHP7 MySQL，支持XCache/Yac/Redis/Memcached等 NoSQL 的方式操作各种数据库。

WellCMS X 1.0.0 采用 MIT 协议发布，您可以自由修改、派生版本、商用而不用担心任何法律风险（修改后应保留原来的版权信息）。',
	'license_date' => '发布时间：2018年10月23日',
