...
return array(
	...
	'license_title' => '感謝您選擇WellCMS X 1.0.0，它是一款傾向移動端的內容管理產品，具有安全、高效、穩定、速度快、負載超強的特點，尤其在大數據量下它的優秀才更顯卓越，同時在SEO方面做了大量優化。基於優秀的XiunoPHP開發，同時沿用了Xiuno bbs的精華之處，作者再次對核心進行了增強，其目的是榨乾硬件的全部運算性能。

WellCMS X 版本中的 X 取自“Extreme”，意為輕便到了極點；意為追求極致；意為自由飛翔，需要輕盈的體態；意為將程序的性能發揮到極限。

它只有18 個表，源代碼壓縮後1M 左右，運行速度非常快，處理單次請求在0.01 秒級別，在有APC、Yac、XCache 的環境下可以跑到0.00x 秒，對第三方類庫依賴極少，僅僅前端依賴jquery.js。分佈式服務器設計，每張表都可創建單獨的DB服務器群和CACHE服務器(群)，單表可承受高達億級數據，方便部署和維護，是一個非常好的二次開發的基石。

WellCMS X 1.0.0 只有 18 個表，源代碼壓縮後 1M 左右，運行速度非常快，處理單次請求在 0.01 秒級別。分佈式服務器設計，每張表都可創建單獨的DB服務器群和CACHE服務器(群)，單表可承受高達億級數據，方便部署和維護，是一個二次開發非常好的基石。

採用 Bootstrap 4 + JQuery 3 作為前端類庫，全面支持移動端瀏覽器；後端基於 PHP7 MySQL，支持XCache/Yac/Redis/Memcached等 NoSQL 的方式操作各種數據庫。

WellCMS X 1.0.0 採用 MIT 協議發布，您可以自由修改、派生版本、商用而不用擔心任何法律風險（修改後應保留原來的版權信息）。',
	'license_date' => '發布時間：2018年10月23日',
	'agree_license_to_continue' => '同意協議繼續安裝',
	'install_title' => 'WellCMS X 1.0.0 安装向导',
	'install_guide' => '安裝向導',
