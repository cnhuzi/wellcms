...
include _include(APP_PATH.'plugin/well_bbs/model/modlog.func.php');
...
if($action == 'top') {
	...
	if($method == 'GET') {
		...
		include _include(APP_PATH.'plugin/well_bbs/view/htm/mod_top.htm');
	...
	if($method == 'GET') {
		...
		include _include(APP_PATH.'plugin/well_bbs/view/htm/mod_close.htm');
	...
	if($method == 'GET') {
		...
		include _include(APP_PATH.'plugin/well_bbs/view/htm/mod_delete.htm');
	...
	if($method == 'GET') {
        ...
        $forumlist_show = well_forum_list($forumlist_show);
        $forumarr = arrlist_key_values($forumlist_show, 'fid', 'name');

		include _include(APP_PATH.'plugin/well_bbs/view/htm/mod_move.htm');
