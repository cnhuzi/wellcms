...
if (empty($action) || $action == 'list') {
    ...
    if ($method == 'GET') {
        ...
        include _include(APP_PATH . 'plugin/well_cms_x/admin/view/htm/group_list.htm');
    ...
    if ($method == 'GET') {
        ...
        include _include(APP_PATH . 'plugin/well_cms_x/admin/view/htm/group_update.htm');
        ...
        $arr = array(
            ...
            'allowdown' => $allowdown,
            // TODO Burning ice
            // hook website_admin_group_update_post_user_allow_before.php
        ...
        if ($_gid >= 1 && $_gid <= 5) {
            ...
            // TODO Burning ice
            // hook website_admin_group_update_post_manage_allow_before.php
            $arr += array(
                'allowtop' => $allowtop,
            ...
            // TODO Burning ice
            // hook website_admin_group_update_post_manage_allow_after.php
        }
