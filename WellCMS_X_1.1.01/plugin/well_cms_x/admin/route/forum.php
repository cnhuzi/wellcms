...
if (empty($action) || $action == 'list') {
    ...
    if ($method == 'GET') {
        ...
        include _include(APP_PATH . 'plugin/well_cms_x/admin/view/htm/forum_list.htm');
    ...
    if ($method == 'GET') {
        ...
        include _include(APP_PATH . 'plugin/well_cms_x/admin/view/htm/forum_update.htm');
...
// 废弃
    ...
    foreach ($arr as $_uid) {
        ...
        if (empty($_user)) {
            $err .= lang('item_not_exists', array('item' => $_uid));
            continue;
        }
        if ($_user['gid'] > 4) {
            $err .= lang('item_not_moderator', array('item' => $_uid));
            continue;
        }
